...
def save_img(data, name):
    ...
    rawData = data.iloc[-20:, [5, 0, 1, 2, 3]].copy()
...
def write_html(l, path):
    ...
    if l:
        ...
        html += '<div class="col-12">\n  <p class="lead">Sorry, could not find anything. Check tomorrow for updates!</p>\n</div>\n\n{% endblock %}\n'
    f = open(path, 'w+')
    f.write(html)
    f.close()
...
symbols = ['CGC', 'TWLO', 'AMD', 'CRON', 'ACB', 'ECL', 'SQ', 'MU', 'SPOT', 'DBX', 'GE', 'F',
            ...
            'XXII', 'SIRI', 'RAD', 'IQ', 'APHA', 'JD', 'WFT', 'JCP', 'CRBP', 'GLUU',
            'CARA', 'VSLR', 'NOK', 'PCG', 'ENPH', 'BILI', 'TRXC', 'HEXO', 'AKS', 'UAA',
            ...
            'PFE', 'COST', 'CRSP', 'LUV', 'BA', 'CVS', 'TGT', 'ABBV', 'QQQ', 'MELI', 'GH', 'RIOT',
